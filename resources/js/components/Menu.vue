<template>
    ...
    <!-- header-height header-option-1 fixed-header -->
    <header
                    ...
                    <div class="d-flex align-items-center justify-content-center w-100 w-lg-auto">
                        ...
                        <div class="nav header-social justify-content-end d-none d-lg-block white-link">
                            <a class="h-social-link"
                                href="https://www.facebook.com/people/Repacar-Reparos/100054473799298/" target="_blank">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a class="h-social-link" href="https://www.instagram.com/repacar_reparos/" target="_blank">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                            ...
                            <div class="container-fluid p-3 p-lg-4">
                                <div class="row gy-4">
                                    <div class="col-6 col-md-4 col-lg-2" v-for="category in categories"
                                        :key="category.Codigo" style="padding-bottom: 2em;">
                    ...
                    <li class="dropdown-full nav-item">
                        <a href="https://www.repacar.com.br/downloads/110720241328021180965542.pdf" class="nav-link"
                    ...
                    <li class="dropdown-full nav-item">
                        <router-link :to="'/representative'" class="nav-link">Seja Um Representante</router-link>
                    </li>
                    <li class="dropdown-full nav-item">
