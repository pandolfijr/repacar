...
<body>
    ...
    <div class="">
{{--
        <header class="header-main bg-mode-re header-light fixed-top header-height header-option-1 fixed-header">
            <!-- Header Top -->
                            ...
                            <ul class="nav ms-auto ms-lg-3">
                                <li class="nav-item">
                                    <a href="#" class="nav-link text-white" data-bs-toggle="modal"
                                        ...
                                        <i class="fi-user me-2"></i>Área do Cliente </a>
                                </li>
                            </ul>
                            <!-- Top social -->
    ...
    <a href="https://wa.me/5516996461315"
